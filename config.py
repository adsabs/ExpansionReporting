...
JOURNALS = {
    ...
    'MUL':['Natur', 'Sci', 'PNAS', 'NatCo', 'NatSR', 'SciA', 'PLoSO', 'RSOC', 'RSPTA', 'RSPSA', 'NatSD'],
    'IEEE': ['ATTTJ','BSTJ','CComm','CEEJ','CJECE','CSE','Compr','ElEng','IAESM','IAHC','IAPGN','IAPM','IAPSN','IASPN','IASSP','IATM','IAWPL','IBITM','ICAL','ICAP','ICD','ICEM','ICGA','ICIM','ICJAS','ICSEn','ICSL','ICSM','ICST','ICStM','ICSyM','ICSys','ICiSM','IClCo','IComL','IComM','ID&T','IDD','IDSO','IDTC','ID\&T','IEDL','IEDM','IEDR','IEEEA','IEEEC','IEEEM','IEEEN','IEEEP','IEEES','IEIM','IEMBM','IEMR','IEMag','IESL','IESM','IExp','IGRSL','IGRSM','IIAM','IIC','IIEM','IIMM','IISA','IISys','IITJ','IITM','IITSM','IJBHI','IJEDS','IJEIE','IJERM','IJESE','IJESS','IJEST','IJFlE','IJISP','IJMAS','IJMMC','IJMic','IJOE','IJPv','IJQE','IJRA','IJRFI','IJSAC','IJSAI','IJSAS','IJSSC','IJSTA','IJSTQ','IJSTS','IJTEH','ILCS','ILCSM','ILECP','ILSL','ILTS','IMGWL','IMMag','IMWCL','IMWTL','IMagL','IMicr','INMag','INanE','INetL','IOAJP','IOJAP','IOJCS','IOJCi','IOJEM','IOJIA','IOJID','IOJIE','IOJIM','IOJIT','IOJN','IOJPE','IOJSE','IOJSP','IOJSS','IOJUF','IOJVT','IPAPN','IPCom','IPDTS','IPEC','IPEL','IPEM','IPER','IPERv','IPETS','IPEWT','IPEnM','IPGAP','IPTGA','IPTL','IPerC','IPhoJ','IPot','IPuls','IRAL','IRAM','IRBE','IRETA','IRETB','IRITA','IRME','IRMag','IRTAC','IRTAN','IRTBE','IRTBT','IRTCP','IRTCS','IRTCT','IRTEC','IRTEM','IRTEW','IRTHF','IRTI','IRTIE','IRTIT','IRTME','IRTNS','IRTPE','IRTRF','IRTSE','IRTUE','IRTVC','ISCSN','ISMCM','ISPL','ISPM','ISPri','ISRev','ISSCL','ISSCM','ISTSP','ISenJ','ISenL','ISoft','ISysJ','ITAC','ITAE','ITAES','ITAI','ITAMD','ITAP','ITAS','ITASE','ITASL','ITASS','ITAdP','ITAen','ITAer','ITAfC','ITApl','ITAuE','ITAud','ITB','ITBBI','ITBC','ITBD','ITBE','ITBME','ITBTR','ITBTS','ITCAD','ITCBB','ITCC','ITCCN','ITCDS','ITCE','ITCHM','ITCI','ITCIA','ITCNS','ITCP','ITCPA','ITCPB','ITCPC','ITCPM','ITCPT','ITCS','ITCSA','ITCSE','ITCSR','ITCSS','ITCST','ITCSV','ITCT','ITCTV','ITCmp','ITCoS','ITCoT','ITCom','ITCyb','ITDEI','ITDMR','ITDSC','ITEC','ITECI','ITECm','ITED','ITEI','ITEM','ITEMP','ITEPM','ITETC','ITEdu','ITElC','ITEnC','ITFR','ITFS','ITFlE','ITGCN','ITGE','ITGRS','ITGam','ITHFE','ITHMS','ITHap','ITIA','ITICP','ITIE','ITIEC','ITIF','ITIGA','ITII','ITIM','ITIP','ITIT','ITITB','ITITS','ITITr','ITIV','ITJMJ','ITKDE','ITLT','ITM','ITMBM','ITMC','ITME','ITMED','ITMI','ITMLC','ITMMS','ITMRB','ITMSC','ITMT','ITMTT','ITMm','ITNB','ITNN','ITNNL','ITNS','ITNSE','ITNSM','ITNSR','ITNan','ITNet','ITPAM','ITPAS','ITPC','ITPD','ITPDS','ITPE','ITPEP','ITPHP','ITPMP','ITPRT','ITPS','ITPSy','ITPT','ITPri','ITPro','ITPv','ITQE','ITR','ITRA','ITRE','ITRFI','ITRPM','ITRQC','ITRS','ITRob','ITSAP','ITSC','ITSCo','ITSE','ITSET','ITSEn','ITSG','ITSIP','ITSM','ITSMA','ITSMB','ITSMC','ITSMg','ITSP','ITSPI','ITSSC','ITSU','ITTE','ITTRC','ITTS','ITTST','ITUE','ITUFF','ITVCG','ITVL','ITVT','ITWC','IVTM','IWC','IWCL','IWEM','JAIEE','JDisT','JEMat','JLwT','JMemS','JOCN','JPES','JTCAD','NIPGA','OJCS','OJCmS','PAIEE','RvIAL','TAIAI','TAICE','TAIEE','TAIPA','TASME','TeSoc','TIAEE','TIGAP','TIGP','TIPAE','TIPAN','TIPBT','TIPCP','TIPCT','TIPEC','TIPEM','TIPGA','TIPGC','TIPGE','TIPGI','TIPIE','TIPIT','TIPME','TIPQC','TIPRQ','TIPUE','TIPVC']
}
...
TOPIC_SETS['Multidisciplinary'] = JOURNALS['MUL']
TOPIC_SETS['IEEE'] = JOURNALS['IEEE']
